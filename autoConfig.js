...
defaults.outFile = null;              // The output filename. A null value means use the original filename, such that abc.fits -> abc.mz
defaults.dir = null;                  // Output directory. A null value means output in the same directory as the fits file. Path is relative to input path
...
defaults.numCPUs = null;              // A null value defaults to using all but one logical CPUs on the host machine
