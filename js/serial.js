AmCharts.AmSerialChart = AmCharts.Class({
    ...
    countColumns: function () {
        ...
        for (n = 0; n < b; n++) {
            ...
            var l = e.stackType;
            if ("100%" == l || "regular" == l)
                for (g = !1, k = 0; k < c; k++) d = this.graphs[k], d.hidden || d.valueAxis != e || "column" != d.type || (!g && d.stackable && (a++, g = !0), !d.stackable && d.clustered && a++, d.columnIndex = a - 1, d.clustered || (d.columnIndex = 0));
            if ("none" == l || "3d" == l)
                for (k = 0; k < c; k++) d = this.graphs[k], !d.hidden &&
    ...
    formatPeriodString: function (a,
        ...
        if (b) {
            ...
            for (var n = 0; n < c.length; n++) {
                for (var l = c[n], h = 0, f = 0, m, u, p, s, y, w = 0, r = 0, q, t, v, z, A, B = this.start; B <= this.end; B++) {
                    var x = g[B];
                    if (x && (x = x.axes[e.id].graphs[b.id])) {
                        if (x.values) {
                            ...
                            if (!isNaN(C)) {
                                ...
                                if (isNaN(p) || p > C) p = C;
                                if (isNaN(s) || s < C) s = C;
                                y = AmCharts.getDecimals(h);
                                var D = AmCharts.getDecimals(C),
                                    h = h + C,
                                    h = AmCharts.roundTo(h, Math.max(y, D));
                                f++;
                                y = h / f
                            }
                        }
                        if (x.percents && (x = x.percents[l], !isNaN(x))) {
                            ...
                            if (isNaN(v) || v > x) v = x;
                            if (isNaN(z) || z < x) z = x;
                            A = AmCharts.getDecimals(w);
                            C = AmCharts.getDecimals(x);
                            w += x;
                            w = AmCharts.roundTo(w, Math.max(A, C));
                            r++;
                            A = w / r
                        }
                    }
                ...
                a = AmCharts.formatValue(a,
                    w, d, this.percentFormatter, "percents\\." + l + "\\.")
            }
        }
        return a
    },
    formatString: function (a, b, c) {
        ...
        if (-1 != a.indexOf("[[category]]")) {
            ...
            if (this.categoryAxis.parseDates) {
                var g = this.balloonDateFormat,
                    k = this.chartCursor;
                k && (g = k.categoryBalloonDateFormat); - 1 != a.indexOf("[[category]]") && (g = AmCharts.formatDate(e, g), -1 != g.indexOf("fff") && (g = AmCharts.formatMilliseconds(g, e)), e = g)
            }
        ...
        a = AmCharts.formatValue(a, b.values, ["percents"], g); - 1 != a.indexOf("[[") && (a = AmCharts.formatDataContextValue(a,
            b.dataContext));
...
AmCharts.Cuboid = AmCharts.Class({
    ...
    draw: function () {
        ...
        var r, q, t, v, z, A, B, x, C, D = n;
        s && (n = 0);
        if (0 < e || 0 < g) B = w, w = AmCharts.adjustLuminosity(y, -0.2), w = AmCharts.adjustLuminosity(y, -0.2), r = AmCharts.polygon(b, [0, e, c + e, c, 0], [0, g, g, 0, 0], w, n, 1, h, 0, m), 0 < f && (C = AmCharts.line(b, [0, e, c + e], [0, g, g], h, f, l, p)), q = AmCharts.polygon(b, [0, 0, c, c, 0], [0, d, d, 0, 0], w, n, 1, h, 0, m), q.translate(e,
            g), 0 < f && (t = AmCharts.line(b, [e, e], [g, g + d], h, f, l, p)), v = AmCharts.polygon(b, [0, 0, e, e, 0], [0, d, d + g, g, 0], w, n, 1, h, 0, m), z = AmCharts.polygon(b, [c, c, c + e, c + e, c], [0, d, d + g, g, 0], w, n, 1, h, 0, m), 0 < f && (A = AmCharts.line(b, [c, c + e, c + e, c], [0, g, d + g, d], h, f, l, p)), w = AmCharts.adjustLuminosity(B, 0.2), B = AmCharts.polygon(b, [0, e, c + e, c, 0], [d, d + g, d + g, d, d], w, n, 1, h, 0, m), 0 < f && (x = AmCharts.line(b, [0, e, c + e], [d, d + g, d + g], h, f, l, p));
        n = D;
        1 > Math.abs(d) && (d = 0);
        1 > Math.abs(c) && (c = 0);
        ...
        d = 0 > d ? [r, C, q, t, v, z, A, B, x, b] : [B, x, q, t, v, z, r, C, A, b];
...
AmCharts.CategoryAxis = AmCharts.Class({
        ...
        if (AmCharts.ifArray(a)) {
            ...
            var r = this.firstDayOfWeek,
                ...
                a = AmCharts.resetDateToMin(new Date(a[a.length -
                    1].time + 1.05 * h), this.minPeriod, 1, r).getTime(),
                t;
            ...
            if (this.parseDates && !this.equalSpacing) {
                ...
                var k = Math.ceil(this.timeDifference / p) + 5,
                    A = f = AmCharts.resetDateToMin(new Date(this.startTime - p), e,
                        u, r).getTime();
                ...
                if (0 < this.gridCountR)
                    for (b = d; b <= k; b++) {
                        ...
                        f = m;
                        if (!isNaN(v))
                            for (h = 1; h < u; h += v) this.gridAlpha =
                ...
                if (this.cellWidth = this.getStepWidth(b), b < k && (k = b), g += this.start, this.stepWidth = this.getStepWidth(b), 0 < k)
                    for (q = Math.floor(b / k), v = this.chooseMinorFrequency(q), h = g, h / 2 == Math.round(h / 2) && h--, 0 > h && (h = 0), k = 0, this.end - h + 1 >= this.autoRotateCount && (this.labelRotation = this.autoRotateAngle), b = h; b <=
                        this.end + 2; b++) {
                        r = !1;
                        ...
                        A = this.cellWidth;
                        u && (A = NaN);
                        this.labelFunction && s && (f = this.labelFunction(f,
                            s, this));
                        f = AmCharts.fixBrakes(f);
                        f = new this.axisItemRenderer(this, h, f, !0, A, r, void 0, !1, r);
                        this.pushAxisItem(f);
                        this.gridAlpha = a
                    }
                ...
                k = Math.ceil(this.timeDifference /
                    p) + 1;
                ...
                if (this.data[h].time != AmCharts.resetDateToMin(new Date(this.data[h].time), e, u, r).getTime())
                    for (r = 0, B = f, b = h; b < y; b++) m = this.data[b].time, this.checkPeriodChange(e,
                        u, m, B) && (r++, 2 <= r && (p = b, b = y), B = m);
                t && 1 < u && (v = this.chooseMinorFrequency(u), AmCharts.getPeriodDuration(e, v));
                for (b = h; b < y; b++)
                    if (m = this.data[b].time, this.checkPeriodChange(e, u, m, f) && b >= p) {
                        ...
                        f = AmCharts.formatDate(new Date(m), f);
                        if (b == d && !n || b == k && !l) f = " ";
                        z ? z = !1 : (q || (t = !1), h - this.previousPos >
                            this.safeDistance * Math.cos(this.labelRotation * Math.PI / 180) && (this.labelFunction && (f = this.labelFunction(f, new Date(m), this)), f = new this.axisItemRenderer(this, h, f, void 0, void 0, void 0, void 0, t), r = f.graphics(), this.pushAxisItem(f), r = r.getBBox().width, AmCharts.isModern || (r -= h), this.previousPos = h + r));
                        f = m
                    } else isNaN(v) || (this.checkPeriodChange(e, v, m, A) && (this.gridAlpha = this.minorGridAlpha, h = this.getCoordinate(b - this.start), t = new this.axisItemRenderer(this, h), this.pushAxisItem(t), A = m), this.gridAlpha = a)
            }
            for (b =
                     0; b < this.data.length; b++)
                if (n = this.data[b]) l = this.parseDates && !this.equalSpacing ? Math.round((n.time - this.startTime) * this.stepWidth + this.cellWidth / 2) : this.getCoordinate(b - g), n.x[this.id] = l;
            n = this.guides.length;
            for (b = 0; b < n; b++) l = this.guides[b], q = q = q = a = d = NaN, v = l.above, l.toCategory && (q = c.getCategoryIndexByValue(l.toCategory), isNaN(q) || (d = this.getCoordinate(q - g), f = new this.axisItemRenderer(this, d, "", !0, NaN, NaN, l), this.pushAxisItem(f, v))), l.category && (q = c.getCategoryIndexByValue(l.category), isNaN(q) || (a =
                this.getCoordinate(q - g), q = (d - a) / 2, f = new this.axisItemRenderer(this, a, l.label, !0, NaN, q, l), this.pushAxisItem(f, v))), l.toDate && (this.equalSpacing ? (q = c.getClosestIndex(this.data, "time", l.toDate.getTime(), !1, 0, this.data.length - 1), isNaN(q) || (d = this.getCoordinate(q - g))) : d = (l.toDate.getTime() - this.startTime) * this.stepWidth, f = new this.axisItemRenderer(this, d, "", !0, NaN, NaN, l), this.pushAxisItem(f, v)), l.date && (this.equalSpacing ? (q = c.getClosestIndex(this.data, "time", l.date.getTime(), !1, 0, this.data.length - 1), isNaN(q) ||
                (a = this.getCoordinate(q - g))) : a = (l.date.getTime() - this.startTime) * this.stepWidth, q = (d - a) / 2, f = "H" == this.orientation ? new this.axisItemRenderer(this, a, l.label, !1, 2 * q, NaN, l) : new this.axisItemRenderer(this, a, l.label, !1, NaN, q, l), this.pushAxisItem(f, v)), d = new this.guideFillRenderer(this, a, d, l), a = d.graphics(), this.pushAxisItem(d, v), l.graphics = a, a.index = b, l.balloonText && this.addEventListeners(a, l)
        }
        this.axisCreated = !0;
        c = this.x;
        g = this.y;
    ...
    choosePeriod: function (a) {
        var b = AmCharts.getPeriodDuration(this.periods[a].period, this.periods[a].count),
            ...
            d = this.periods;
        return this.timeDifference < b && 0 < a ? d[a - 1] : c <= this.gridCountR ? d[a] : a + 1 < d.length ?
            this.choosePeriod(a + 1) : d[a]
    },
    ...
    xToIndex: function (a) {
        var b = this.data,
            ...
            d = c.rotate,
            e = this.stepWidth;
        this.parseDates && !this.equalSpacing ? (a = this.startTime +
            Math.round(a / e) - this.minDuration() / 2, c = c.getClosestIndex(b, "time", a, !1, this.start, this.end + 1)) : (this.startOnAxis || (a -= e / 2), c = this.start + Math.round(a / e));
