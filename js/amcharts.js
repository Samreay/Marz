...
AmCharts.ValueAxis = AmCharts.Class({
    ...
    draw: function () {
        ...
        if (this.logarithmic && (0 >= this.getMin(0, this.data.length -
            ...
            if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max) g = !0;
                ...
                var r = this.step,
                    K, z = this.minorGridAlpha;
                this.minorGridEnabled && (K = this.getMinorGridStep(r, this.stepWidth *
                    r));
                for (d = n; d < q; d += p)
                    if (n = r * d + this.min, n = AmCharts.roundTo(n, this.maxDecCount + 1), !this.integersOnly || Math.round(n) == n)
    ...
    getMinorGridStep: function (a, b) {
        ...
        for (var d = Math.floor(Math.log(Math.abs(a)) * Math.LOG10E), f = 0; f < c.length; f++) {
            var e = a / c[f],
                g = Math.floor(Math.log(Math.abs(e)) *
                    Math.LOG10E);
            if (!(0 < Math.abs(d - g)))
                if (1 > a) {
                ...
                if (c.hasOwnProperty(d)) {
                    ...
                    if (f.includeInMinMax && (!f.hidden || this.includeHidden)) {
                        ...
                        if (this.minMaxField) e = f[this.minMaxField],
                            ...
                            for (var g in f) f.hasOwnProperty(g) && "percents" != g && "total" != g && (e = f[g], e > a && (a = e))
                    }
                }
        }
        return a
...
AmCharts.RecItem = AmCharts.Class({
    construct: function (a, b, c, d, f, e, g, h, k, l) {
        ...
        x && (x.attr({
            "text-anchor": N
        }), x.translate(H, E), 0 !== A && x.rotate(-A, a.chart.backgroundColor), a.allLabels.push(x), " " != c && (this.label = x));
...
AmCharts.AmGraph = AmCharts.Class({
    ...
    createSerialGraph: function () {
        ...
        var l = this.width,
            ...
            u = [],
            v = [],
            t, w, z, F, y = this.chart.graphs.length,
            B, G = this.dx / this.depthCount,
            K = this.dy / this.depthCount,
            A = e.stackType,
        ...
        if (!U && ("line" == g || "smoothedLine" == g || "step" == g) && (1 == d.length && "step" != g && "none" == this.bullet && (this.bullet = "round", this.resetBullet = !0), Oa || void 0 != Da)) {
            ...
            var ya = e.getCoordinate(Ha),
                yb = e.getCoordinate(e.max);
        ...
        if ("line" == g || "step" == g || "smoothedLine" == g) {
            if (0 < T) {
                for (I = T - 1; - 1 < I; I--)
                    if (ha = d[I], x = ha.axes[e.id].graphs[b], Wa = x.values.value, !isNaN(Wa)) {
                        T = I;
                        break
                    }
                if (this.lineColorField)
                    for (I = T; - 1 < I; I--)
                        if (ha = d[I], x = ha.axes[e.id].graphs[b],
                            x.lineColor) {
                ...
                if (this.fillColorsField)
                    for (I = T; - 1 < I; I--)
                        if (ha = d[I], x = ha.axes[e.id].graphs[b], x.fillColors) {
                            this.fillColorsSwitched = x.fillColors;
                            break
                        }
                if (this.dashLengthField)
                    for (I = T; - 1 < I; I--)
                        if (ha = d[I], x = ha.axes[e.id].graphs[b], !isNaN(x.dashLength)) {
                            this.dashLengthSwitched = x.dashLength;
                            break
                        }
            }
            if (ca < d.length - 1)
                for (I = ca + 1; I < d.length; I++)
                    if (ha = d[I], x = ha.axes[e.id].graphs[b], Wa = x.values.value, !isNaN(Wa)) {
                        ca = I;
                        break
                    }
        ...
        var X = [],
            ...
            Ea = !1;
        if ("line" == g || "step" == g || "smoothedLine" == g)
            if (this.stackable && "regular" == A || "100%" == A || this.fillToGraph) Ea = !0;
        ...
        for (I = T; I <= ca; I++) {
            ...
            if (ua) {
                ...
                var ia = ha.x[Na.id],
                    ...
                    la = Math.floor(R / 2) + Math.floor(Ka * R / 2),
                    va = la,
                    Ab = 0;
                ...
                switch (g) {
                    case "line":
                        if (isNaN(Z)) r || (this.drawLineGraph(u, v, X, Y), u = [], v = [], X = [], Y = []);
                        else {
                        ...
                        break;
                    case "smoothedLine":
                        if (isNaN(Z)) r || (this.drawSmoothedGraph(u, v, X, Y), u = [], v = [], X = [], Y = []);
                        else {
                            x.isNegative = Z < ma ? !0 : !1;
                            if (Math.abs(D - ab) >= cb || Math.abs(C - bb) >= cb) u.push(D), v.push(C), ab = D, bb = C;
                            ba = D;
                            ...
                            if (!(Z < Bb && na < Bb || Z > Cb && na > Cb))
                                if (n) {
                                    ...
                                    aa = AmCharts.fitToBounds(aa, -O, l - O + G *
                                        Q);
                                    if (P < m && 0 < M && (qa = new AmCharts.Cuboid(f, aa, M, G - a.d3x, K - a.d3y, Ca, Ra, V, oa, $, H, s, n, N, Sa), "bottom" != S && "inside" != S && "middle" != S))
                                        if (S = e.reversed ? "left" : "right", 0 > Z) S = e.reversed ? "right" : "left";
                                        else if ("regular" == A || "100%" == A) ba += this.dx
                                } else {
                                    ...
                                    if (O < l + Q * G && 0 < M)
                                        if (qa = new AmCharts.Cuboid(f,
                                            M, aa, G - a.d3x, K - a.d3y, Ca, Ra, V, oa, this.lineAlpha, H, s, n, N, Sa), 0 > Z && "middle" != S && "inside" != S) S = "bottom";
                                        else if (S = pa, "regular" == A || "100%" == A) fa += this.dy
                                }
                    ...
                    case "candlestick":
                        if (!isNaN(na) && !isNaN(Z)) {
                            ...
                            if (n) {
                                ...
                                var qa = new AmCharts.Cuboid(f, M, aa, G, K, Ca, Ra, V, oa, $, H, s, n, N, Sa),
                                    pb, qb;
                        ...
                        if (Gb) {
                            ...
                            switch (S) {
                                ...
                                case "right":
                                    ...
                                    break;
                                case "bottom":
                                    n && "column" == g ? (ba = ga, 0 > Z || 0 < Z && e.reversed ? (wa = -6, ea.attr({
                                        "text-anchor": "end"
                                    })) :
                                        (wa = 6, ea.attr({
                                            "text-anchor": "start"
                            ...
                            if (ea) {
                                ...
                                else if (ba += wa, fa += xa, ea.translate(ba,
                                    fa), n) {
    ...
    drawLineGraph: function (a, b, c, d) {
        ...
        if (1 < a.length) {
            ...
            var l = f.lineAlpha,
                ...
                e = f.fillAlphas,
                p = f.lineColorR,
                n = f.negativeLineAlpha;
            isNaN(n) && (n = l);
            var q = f.lineColorSwitched;
            q && (p = q);
            var q = f.fillColorsR,
                s = f.fillColorsSwitched;
            s && (q = s);
            var r = f.dashLength;
            (s = f.dashLengthSwitched) && (r = s);
            var s = f.negativeLineColor,
                u = f.negativeFillColors,
                v = f.negativeFillAlphas,
                t = f.baseCoord;
            ...
            if (0 < e || 0 < v)
                if (m = a.join(";").split(";"), n = b.join(";").split(";"), "serial" == f.chart.type && (0 < c.length ? (c.reverse(), d.reverse(), m = a.concat(c), n = b.concat(d)) : f.rotate ? (n.push(n[n.length - 1]), m.push(t), n.push(n[0]), m.push(t), n.push(n[0]), m.push(m[0])) : (m.push(m[m.length -
        ...
        if (this.enabled) {
            ...
            if (n) {
                var q = n.x[e.id],
                    ...
                    G = c.graphs,
                    K = e.axisThickness;
                if (c.mouseIsOver || y || B || this.forceShow)
                    if (this.forceShow = !1, B) {
                        ...
                        0 !== d && (g = {
                            type: "zoomed",
                            target: this
                        }, g.chart = this.chart, e.parseDates && !e.equalSpacing ? (c + d > w && (d = w - c), y + d < t && (d = t - y), g.start = y + d, g.end =
                        ...
                        0 < this.cursorAlpha && (t = this.line, s ? (w = 0, u = q + h) : (w = q, u = 0), z = this.animationDuration, 0 < z && !this.zooming ? isNaN(this.previousX) ?
                            t.translate(w, u) : (t.translate(this.previousX, this.previousY), t.animate({
                            translate: w + "," + u
                        }, z, "easeOutSine")) : t.translate(w, u), this.previousX = w, this.previousY = u, t.show());
                        ...
                        if (a != this.previousIndex || A != this.previousMostCloseGraph)
                            if (this.normalizeBulletSize(), this.destroyValueBalloons(), this.resizedBullets = [], G && this.valueBalloonsEnabled && u && c.balloon.enabled) {
                                this.valueBalloons = h = [];
                                for (w = 0; w < G.length; w++)
                                    if (e = G[w], (!this.oneBalloonOnly || e ==
                                        ...
                                        if (this.showNextAvailable && isNaN(t) && a + 1 < this.data.length)
                                            for (q = a + 1; q < this.data.length; q++)
                                                if (r = this.data[q])
                                                    if (v = r.axes[e.valueAxis.id].graphs[e.id], t = v.y, !isNaN(t)) break;
                                        if (!isNaN(t)) {
                                            r = v.x;
                                            u = !0;
                                            if (s) {
                        ...
                        b ?
                            (g = {
                                type: "changed"
                            }, g.index = a, g.chart = this.chart, g.zooming = y, g.mostCloseGraph = A, g.position = s ? f : d, g.target = this, c.fire("changed", g), this.fire("changed", g), this.skipZoomDispatch = !1) : (this.skipZoomDispatch = !0, c.updateLegendValues(a));
            ...
            if (this.enabled && 0 < b.length) {
                if (this.pan) this.rolledOver = !1;
                    ...
                    if ("cursor" == this.type) this.rotate ? this.selectionPosY = f : this.selectionPosX = f = d, 2 > Math.abs(f - this.initialMouse) && this.fromIndex == this.index || (this.index < this.fromIndex ? (c.end = this.fromIndex, c.start = this.index) :
                        (c.end = this.index, c.start = this.fromIndex), f = a.categoryAxis, f.parseDates && !f.equalSpacing && (c.start = b[c.start].time, c.end = a.getEndTime(b[c.end].time)), this.skipZoomDispatch || this.fire(c.type, c));
                    else {
    ...
    draw: function () {
        ...
        if (l = a.graph) {
            ...
            for (q = 0; q < c.length; q++) {
                var s = c[q].axes[n.id].graphs[l.id].values,
                    r;
                for (r in s)
                    if (s.hasOwnProperty(r) && "percents" != r && "total" != r) {
                        var u = s[r];
                        u < e && (e = u);
                        u > g && (g = u)
                    }
            }
            Infinity != e && (p.minimum = e); - Infinity != g && (p.maximum = g + 0.1 * (g - e));
...
AmCharts.AmSlicedChart = AmCharts.Class({
    ...
    rollOverSlice: function (a, b, c) {
        ...
        if (!a.hidden) {
            ...
            var e = this.formatString(this.balloonText, a, !0),
...
AmCharts.makeHD = function (a, b, c) {
    for (var d = [], f = [], e = 1; e < a.length; e++)
        for (var g = Number(a[e - 1]), h = Number(b[e - 1]), k = Number(a[e]), l = Number(b[e]), m = Math.sqrt(Math.pow(k - g, 2) + Math.pow(l - h, 2)), m = Math.round(m / 50) + 1, k = (k - g) / m, l = (l - h) / m, p = 0; p <= m; p++) {
            var n = g + p * k + Math.random() * c,
                q = h + p * l + Math.random() * c;
            d.push(n);
            f.push(q)
        }
    return [d, f]
...
AmCharts.handDrawnLine = function (a, b, c, d, f, e, g, h, k, l, m) {
    ...
    for (m = 1; m < b.length; m++)
        for (var n = [b[m - 1], b[m]], q = [c[m - 1], c[m]], q = AmCharts.makeHD(n, q, a.handDrawScatter), n = q[0], q = q[1], s = 1; s < n.length; s++) p.push(AmCharts.line(a, [n[s - 1], n[s]], [q[s - 1], q[s]], d, f, e + Math.random() * a.handDrawThickness - a.handDrawThickness / 2, g, h, k, l, !0));
    return p
};
...
AmCharts.wedge = function (a, b, c, d, f, e, g, h, k, l, m, p) {
    ...
    var u = 1 / 180 * Math.PI,
        ...
        t = b + Math.sin(d * u) * e,
        w = c - Math.cos(d * u) * g,
        z = b + Math.sin((d + f) * u) * e,
        F = c - Math.cos((d + f) * u) * g,
        y = b + Math.sin((d + f) * u) * h,
        u = c - Math.cos((d + f) * u) * q,
        B = {
    ...
    createEntry: function (a) {
        if (!1 !== a.visibleInLegend) {
            ...
            if (this.useGraphSettings)
                if (m = a.type, this.switchType = void 0, "line" == m || "step" == m || "smoothedLine" == m || "ohlc" == m) g = k.set(), a.hidden || (d = a.lineColorR, e = a.bulletBorderColorR), p = AmCharts.line(k, [0, 2 * l], [l / 2, l / 2], d, a.lineAlpha, a.lineThickness, a.dashLength), g.push(p), a.bullet && (a.hidden ||
                    (d = a.bulletColorR), p = AmCharts.bullet(k, a.bullet, a.bulletSize, d, a.bulletAlpha, a.bulletBorderThickness, e, a.bulletBorderAlpha)) && (p.translate(l + 1, l / 2), g.push(p)), n = 0, m = l, p = l / 3;
                else {
                    var q;
