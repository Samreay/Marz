AmCharts.AmStockChart = AmCharts.Class({
    ...
    write: function (a) {
        ...
        this.categoryAxesSettings = AmCharts.processObject(this.categoryAxesSettings,
            AmCharts.CategoryAxesSettings, b);
    ...
    getLastDate: function (a) {
        ...
        a = a instanceof Date ? new Date(a.getFullYear(), a.getMonth(), a.getDate(), a.getHours(), a.getMinutes(), a.getSeconds(),
            a.getMilliseconds()) : b ? AmCharts.stringToDate(a, b) : new Date(a);
    ...
    createLayout: function () {
        ...
        if ("left" == b || "left" == c) a = document.createElement("div"), a.style.cssFloat = "left", a.style.styleFloat =
            "left", a.style.width = "0px", a.style.position = "absolute", d.appendChild(a), this.leftContainer = a;
    ...
    measurePanels: function () {
        ...
        for (e = 0; e < a.length; e++) h = a[e], h.percentHeight = h.percentHeight / d * 100, h.panelBox && (h.panelBox.style.height = Math.round(h.percentHeight * this.panelsHeight / 100) + "px")
    },
    ...
    updatePanel: function (a) {
        ...
        c = a.valueAxes;
        d = c.length;
        for (b = 0; b < d; b++) e = c[b], AmCharts.copyProperties(this.valueAxesSettings,
            e);
        a.listenersAdded = !1;
        a.write(a.panelBox)
    },
    ...
    updatePanelsWithNewData: function () {
        ...
        if (a) {
            ...
            b && (c = this.categoryAxesSettings, d = c.minPeriod, b.categoryField = a.categoryField, 0 < a.dataProvider.length ?
                (e = this.chartScrollbarSettings.usePeriod, b.dataProvider = e ? a.agregatedDataProviders[e] : a.agregatedDataProviders[d]) : b.dataProvider = [], e = b.categoryAxis, e.minPeriod = d, e.firstDayOfWeek = this.firstDayOfWeek, e.equalSpacing = c.equalSpacing, e.markPeriodChange = c.markPeriodChange, b.bbsetr = !0, b.validateData());
        ...
        if (a) {
            ...
            switch (a.position) {
                ...
                case "top":
                    ...
                    break;
                case "bottom":
                    e.style.marginTop = c + "px", "bottom" == d ? g.insertBefore(e, b) : g.appendChild(e)
            }
    ...
    addCursor: function (a) {
        ...
        if (b.enabled) {
            ...
            this.listenTo(c,
                "onHideCursor", this.hideChartCursor);
    ...
    zoomChart: function (a, b) {
        ...
        if (d && e) {
            ...
            b || (b = e);
            if (h) {
                var u = AmCharts.extractPeriod(h);
                a.getTime() == b.getTime() && u != g && (b = AmCharts.changeDate(b,
                    u.period, u.count), b.setTime(b.getTime() - 1))
            }
            ...
            g = new Date(a);
            g.getTime() == d.getTime() && (g = AmCharts.resetDateToMin(a, f.period, f.count,
                x));
            for (d = 0; d < q.length; d++) {
                ...
                if (h != e) {
                    ...
                    n.firstDayOfWeek = x;
                    n.minPeriod = h;
                    u.dataProvider = c.mainDataSet.agregatedDataProviders[h];
                    if (n = u.chartCursor) n.categoryBalloonDateFormat = c.chartCursorSettings.categoryBalloonDateFormat(f.period), u.showCategoryAxis || (n.categoryBalloonEnabled = !1);
                    u.startTime = g.getTime();
                    u.endTime = b.getTime();
                    u.validateData(!0)
                }
                n = !1;
                u.chartCursor && u.chartCursor.panning &&
                (n = !0);
                n || (u.startTime = void 0, u.endTime = void 0, u.zoomToDates(g, b));
                0 < k.startDuration && c.animationPlayed ? (u.startDuration = 0, u.animateAgain()) : 0 < k.startDuration && u.animateAgain()
            }
            c.animationPlayed = !0;
            AmCharts.extractPeriod(h);
            k = new Date(b);
            t && c.updateScrollbar && (t.zoomToDates(a, k), c.skipScrollbarEvent = !0, setTimeout(function () {
                c.resetSkip.call(c)
            }, 100));
            c.updateScrollbar = !0;
            c.startDate = a;
            ...
            if (a.getTime() != c.previousStartDate.getTime() || b.getTime() != c.previousEndDate.getTime()) m = {
                type: "zoomed"
            }, m.startDate = a, m.endDate = b, m.chart = c, m.period = h, c.fire(m.type, m), c.previousStartDate = new Date(a), c.previousEndDate = new Date(b)
        }
        c.eventsHidden && c.showHideEvents(!1);
        c.chartCreated || (h = "init", c.fire(h, {
            type: h,
            chart: c
        }));
        c.chartRendered || (h = "rendered", c.fire(h, {
            type: h,
            chart: c
        }), c.chartRendered = !0);
        h = "drawn";
        ...
        if (0 < this.dataSets.length) {
            ...
            for (b = 0; b < a.length; b++) {
                ...
                for (e = 0; e < d.length; e++) {
                    ...
                    h.recalculateToPercents = "always" == c.recalculateToPercents ? !0 : !1
                }
                d = this.mainDataSet;
                ...
                for (f = 0; f < h.length; f++) {
                    ...
                    g.useDataSetColors &&
                    (g.lineColor = d.color, g.fillColors = void 0, g.bulletColor = void 0);
                    c.addGraph(g);
                    var k = !1;
                    "always" == c.recalculateToPercents && (k = !0);
                    var m = c.stockLegend,
                        q, y, t, x;
                    m && (m = AmCharts.processObject(m, AmCharts.StockLegend, this.theme), c.stockLegend = m, q = m.valueTextComparing, y = m.valueTextRegular, t = m.periodValueTextComparing, x = m.periodValueTextRegular);
                    if (g.comparable) {
                        var u = e.length;
                        0 < u && g.valueAxis.logarithmic && "never" != c.recalculateToPercents && (g.valueAxis.logarithmic = !1, g.valueAxis.prevLog = !0);
                        0 < u && "whenComparing" ==
                            c.recalculateToPercents && (g.valueAxis.recalculateToPercents = !0);
                        m && g.valueAxis && !0 === g.valueAxis.recalculateToPercents && (k = !0);
                        var n;
                        for (n = 0; n < u; n++) {
                            var w = e[n],
                            ...
                            if (D) {
                                ...
                                if (l = g.compareGraphNegativeFillColors) p.negativeFillColors =
                                    l;
                                if (l = g.compareGraphFillAlphas) p.fillAlphas = l;
                                if (l = g.compareGraphNegativeFillAlphas) p.negativeFillAlphas = l;
                                ...
                                if (l = g.compareGraphBulletBorderColor) p.bulletBorderColor = l;
                                ...
                                p.hideBulletsCount = g.hideBulletsCount;
                                p.valueAxis = g.valueAxis;
                                m && (k && q ? (p.legendValueText = q, p.legendPeriodValueText = t) : (y && (p.legendValueText = y), x && (p.legendPeriodValueText = x)));
                                c.addGraph(p);
                    ...
                    m && (k && q ? (g.legendValueText = q, g.legendPeriodValueText = t) : (y && (g.legendValueText = y), x && (g.legendPeriodValueText = x)))
                }
            }
        }
    },
    ...
    handleCursorChange: function (a) {
        ...
        for (e = 0; e < d.length; e++) {
            var h = d[e];
            h != b && c && (h.isZooming(a), h.previousMousePosition = NaN, h.forceShow = !0, h.setPosition(c, !1))
        }
    },
...
AmCharts.PeriodSelector = AmCharts.Class({
    ...
    zoom: function (a, b) {
        this.inputFieldsEnabled && (this.startDateField.value = AmCharts.formatDate(a, this.dateFormat),
    ...
    write: function (a) {
        ...
        if (b.inputFieldsEnabled) {
            ...
            AmCharts.isIE && k.attachEvent("onkeypress",
                function (a) {
                    b.handleCalendarChange.call(b, a)
                });
            f.appendChild(k);
        ...
        if (AmCharts.ifArray(f)) {
            ...
            d || (g.style.cssFloat = "right", g.style.styleFloat = "right", g.style.display = "inline");
            a.appendChild(g);
            d && AmCharts.addBr(g);
            ...
            b.periodContainer = g;
            var q;
            for (a = 0; a < f.length; a++) k = f[a], q = document.createElement("input"), q.type = "button", q.value =
                k.label, q.period = k.period, q.count = k.count, q.periodObj = k, q.className = "amChartsButton", c && AmCharts.applyStyles(q.style, c.PeriodButton), d && (q.style.width = b.width - 1 + "px"), q.style.boxSizing = "border-box", g.appendChild(q), b.addEventListeners(q), k.button = q;
    ...
    selectPeriodButton: function (a, b, c) {
        var d = a.button,
            e = d.count,
            h = d.period,
            f, g, k = this.firstDate,
            m = this.lastDate,
            q, y = this.theme;
        k && m && ("MAX" == h ? (f = k, g = m) : "YTD" == h ? (f = new Date, f.setMonth(0, 1), f.setHours(0, 0, 0, 0), 0 === e && f.setDate(f.getDate() - 1), g = this.lastDate) : (q = AmCharts.getPeriodDuration(h,
            e), this.selectFromStart ? (f = k, g = new Date(k.getTime() + q - 1)) : (f = new Date(m.getTime() - q + 1), g = m)), a.startTime = f.getTime(), this.hideOutOfScopePeriods && (b && a.startTime < k.getTime() ? d.style.display = "none" : d.style.display = "inline"), f.getTime() > m.getTime() && (q = AmCharts.getPeriodDuration("DD", 1), f = new Date(m.getTime() - q)), f.getTime() < k.getTime() && (f = k), "YTD" == h && (a.startTime = f.getTime()), a.endTime = g.getTime(), b || (this.skipMark = !0, this.unselectButtons(), d.className = "amChartsButtonSelected", y && AmCharts.applyStyles(d.style,
            y.PeriodButtonSelected), a = {
            type: "changed"
        }, a.startDate = f, a.endDate = g, a.predefinedPeriod = h, a.chart = this.chart, a.count = e, a.event = c, this.fire(a.type, a)))
    },
    markButtonAsSelected: function () {
        if (!this.skipMark) {
            ...
            for (e = b.length - 1; 0 <= e; e--) {
                var h = b[e],
                    f = h.button;
                h.startTime && h.endTime && c == h.startTime && a == h.endTime && (this.unselectButtons(), f.className = "amChartsButtonSelected", d && AmCharts.applyStyles(f.style,
...
AmCharts.StockPanel = AmCharts.Class({
    ...
    createDrawIcons: function () {
        ...
        var m = c.image(d + "eraserIcon.gif",
            b + 1, 0, b, b);
        a.eraserButton = m;
        f.mouseup(function () {
            a.handleEraserClick()
    ...
    handleTrendClick: function (a) {
        this.erasingEnabled && (a = a.trendLine,
            this.eraseAll || a.isProtected || this.removeTrendLine(a), this.validateNow())
    },
...
AmCharts.parseStockData = function (a, b, c, d, e) {
    ...
    if (g) {
        var k = AmCharts.getItemIndex(b, c),
            ...
            q, y = f.length,
            t, x = {};
        for (q = k; q < m; q++) t = c[q], h[t] = [];
        var u = {}, n = a.fieldMappings,
            w = n.length;
        for (q = 0; q < y; q++) {
            var p = f[q],
                l = p[g],
                l = l instanceof Date ? "fff" == b ? AmCharts.useUTC ? new Date(l.getUTCFullYear(), l.getUTCMonth(), l.getUTCDate(), l.getUTCHours(), l.getUTCMinutes(), l.getUTCSeconds(), l.getUTCMilliseconds()) : new Date(l.getFullYear(), l.getMonth(),
                    l.getDate(), l.getHours(), l.getMinutes(), l.getSeconds(), l.getMilliseconds()) : new Date(l) : e ? AmCharts.stringToDate(l, e) : new Date(l),
                D = l.getTime(),
                A = {};
            for (t = 0; t < w; t++) A[n[t].toField] = p[n[t].fromField];
            var z;
            for (z = k; z < m; z++) {
                t = c[z];
                ...
                if (z == k || D >= x[t] || !x[t]) {
                    u[t] = {};
                    u[t].amCategoryIdField = String(AmCharts.resetDateToMin(l, B, E, d).getTime());
                    var C;
                    for (C = 0; C < w; C++) s = n[C].toField, v = u[t], r = Number(A[s]), v[s + "Count"] = 0, v[s + "Sum"] = 0, isNaN(r) || (v[s + "Open"] =
                        r, v[s + "Sum"] = r, v[s + "High"] = r, v[s + "Low"] = r, v[s + "Close"] = r, v[s + "Count"] = 1, v[s + "Average"] = r);
                    v.dataContext = p;
                    h[t].push(u[t]);
                    z > k && (s = new Date(l), s = AmCharts.changeDate(s, B, E, !0), s = AmCharts.resetDateToMin(s, B, E, d), x[t] = s.getTime());
                    if (z == k)
                        for (var F in p) p.hasOwnProperty(F) && (u[t][F] = p[F]);
                    u[t][g] = new Date(l)
                } else
                    for (B = 0; B < w; B++) s = n[B].toField, v = u[t], q == y - 1 && (v[g] = new Date(l)), r = Number(A[s]), isNaN(r) || (isNaN(v[s + "Low"]) && (v[s + "Low"] = r), r < v[s + "Low"] && (v[s + "Low"] = r), isNaN(v[s + "High"]) && (v[s + "High"] = r),
                        r > v[s + "High"] && (v[s + "High"] = r), v[s + "Close"] = r, E = AmCharts.getDecimals(v[s + "Sum"]), C = AmCharts.getDecimals(r), v[s + "Sum"] += r, v[s + "Sum"] = AmCharts.roundTo(v[s + "Sum"], Math.max(E, C)), v[s + "Count"]++, v[s + "Average"] = v[s + "Sum"] / v[s + "Count"])
            }
        }
    }
...
AmCharts.parseEvents = function (a, b, c, d, e, h) {
    ...
    for (m = 0; m < k; m++) {
        ...
        y = x.length;
        var p;
        for (q = 0; q < y; q++) t = x[q], t.customBulletField = "amCustomBullet" + t.id + "_" + u.id, t.bulletConfigField = "amCustomBulletConfig" + t.id + "_" + u.id;
        for (var l = 0; l < f.length; l++)
            if (n = f[l], p = n.graph, AmCharts.isString(p) && (p = AmCharts.getObjById(x, p))) n.graph = p
    }
    for (var D in g)
        if (g.hasOwnProperty(D)) {
            ...
            for (s =
                ...
                var l = A.count,
                    v;
                v = "fff" == x ? m.getTime() + 1 : AmCharts.resetDateToMin(AmCharts.changeDate(new Date(m), A.period, A.count), x, l, d).getTime();
                for (m = 0; m < k; m++)
                    for (u = b[m], x = u.graphs, y = x.length, q = 0; q < y; q++) {
                        t = x[q];
                        var r = {};
                        r.eventDispatcher = e;
                        r.eventObjects = [];
                        ...
                        for (l = 0; l < f.length; l++) {
                            ...
                            n.graph && (n.graph.showEventsOnComparedGraphs && n.graph.comparedGraphs[a.id] && (C = !0), (t == n.graph || C) && w >= E && w < v && (r.eventObjects.push(n), r.letters.push(n.text), r.descriptions.push(n.description), n.type ? r.shapes.push(n.type) : r.shapes.push(c.type), void 0 !== n.backgroundColor ? r.backgroundColors.push(n.backgroundColor) : r.backgroundColors.push(c.backgroundColor),
                                ...
                                new Date(n.date)));
                            0 < r.shapes.length && (n = "amCustomBullet" + t.id + "_" + u.id, w = "amCustomBulletConfig" + t.id + "_" + u.id, B[n] = AmCharts.StackedBullet, B[w] = r)
                        }
                    }
            }
        }
...
AmCharts.DataSetSelector = AmCharts.Class({
    ...
    write: function (a) {
        ...
        if (1 < b.countDataSets("showInSelect")) {
            ...
            f && (m.style.width = f);
            b.selectCB = m;
            d && AmCharts.applyStyles(m.style,
                d.DataSetSelect);
            a.appendChild(m);
        ...
        if (0 < b.countDataSets("showInCompare") && 1 < e.length)
            if (h ? (AmCharts.addBr(a),
                AmCharts.addBr(a)) : (c = document.createTextNode(" "), a.appendChild(c)), c = document.createTextNode(b.compareText), a.appendChild(c), k = b.listCheckBoxSize, h) {
                AmCharts.addBr(a);
                f = document.createElement("div");
                a.appendChild(f);
                ...
                for (c = 0; c < e.length; c++) g = e[c], !0 === g.showInCompare && g != b.chart.mainDataSet && (d =
                    ...
                    h.style.whiteSpace = "nowrap", h.style.cursor = "default", h.appendChild(g), b.addEventListeners(d));
                AmCharts.addBr(a);
                AmCharts.addBr(a)
            } else {
                ...
                for (c = 0; c < e.length; c++)
                    if (g =
                        e[c], !0 === g.showInCompare && g != b.chart.mainDataSet) {
                        k = document.createElement("option");
                        k.text = g.title;
                        k.value = c;
    ...
    addEventListeners: function (a) {
        ...
        AmCharts.isIE && (a.attachEvent("onmouseout",
            function (a) {
                b.handleRollOut.call(b, a)
    ...
    handleCBSelect: function (a) {
        ...
        c = b.selectedIndex;
        0 < c && (e = this.dataProvider[b.options[c].value],
            e.compared || (a = {
...
AmCharts.StackedBullet = AmCharts.Class({
    ...
    addLetter: function (a, b, c) {
        ...
        void 0 === a && (a = "");
        a = AmCharts.text(d, a, t, this.chart.fontFamily, this.fontSize);
        d = a.getBBox();
        this.labelWidth = t = d.width;
        ...
        this.bullets[c] = m;
        this.showOnAxis ? (m = isNaN(this.nextAxisY) ?
            this.axisCoordinate : this.nextY, k = f * e, this.nextAxisY = m + e * d) : (m = this.nextY, k = f * e);
        a.translate(g, k);
        b.push(a);
        b.translate(0, m);
    ...
    drawSign: function (a) {
        ...
        var c = this.mastHeight * b,
            ...
            h = AmCharts.circle(this.container, d, this.backgroundColor, this.backgroundAlpha, 1, this.borderColor, this.borderAlpha);
        h.translate(0, c + d * b);
        a.push(e);
        a.push(h);
        this.set.push(a);
